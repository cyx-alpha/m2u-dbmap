...
feature_len_dict = {
    'SleePyCo': [[5, 24, 120], [10, 48, 240], [15, 72, 360], [20, 96, 480], [24, 120, 600], [29, 144, 720], [34, 168, 840], [39, 192, 960], [44, 216, 1080], [48, 240, 1200],[],[],[],[],[72, 360, 1800]],
}
...
class Transformer(nn.Module):
    ...
    def forward(self, x):
        ...
        pooled_token = x.clone()
        if self.cfg['dropout']:
            x = self.dropout(x)
        
        out = self.fc(x)
        
        return out, transformer_features, pooled_token
